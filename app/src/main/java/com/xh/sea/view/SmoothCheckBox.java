...
import com.xh.sea.R;
import com.xh.sea.util.CompatUtils;
...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private static final int COLOR_CHECKED   = Color.parseColor("#303F9F");
    private static final int COLOR_FLOOR_UNCHECKED = Color.parseColor("#2560CE");
